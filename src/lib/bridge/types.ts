...
export interface ChannelBinding {
  ...
  /** Engine type this binding routes to, default 'claude'. */
  engineType: string;
  /** Engine-native session/thread id for resume. */
  engineSessionId: string;
  /** Compatibility alias of engineSessionId for Claude-era call sites. */
  sdkSessionId: string;
