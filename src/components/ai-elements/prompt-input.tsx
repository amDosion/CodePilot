...
export const PromptInputFooter = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={cn("justify-between gap-1 flex-wrap", className)}
    {...props}
  />
);
...
export const PromptInputTools = ({
  ...
  <div
    className={cn("flex min-w-0 items-center gap-1 flex-wrap", className)}
    {...props}
  />
);
...
export type PromptInputApprovalPolicyProps = {
  value: string;
  label?: string;
...
const DEFAULT_APPROVAL_OPTIONS: ApprovalPolicyOption[] = [
  { value: "suggest", label: "Suggest" },
  { value: "auto-edit", label: "Auto Edit" },
  { value: "full-auto", label: "Full Auto" },
];

export const PromptInputApprovalPolicy = ({
  value,
  label = "Approval",
  options = DEFAULT_APPROVAL_OPTIONS,
  onSelect,
  className,
}: PromptInputApprovalPolicyProps) => {
...
/** Small chevron arrow used inside toolbar buttons. */
