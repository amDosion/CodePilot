...
export function normalizeBundledLanguage(language: string | null | undefined): BundledLanguage {
...
export const highlightCode = (
  ...
  const language = normalizeBundledLanguage(languageInput);
...
export const CodeBlock = ({
  ...
  const normalizedLanguage = useMemo(() => normalizeBundledLanguage(language), [language]);
